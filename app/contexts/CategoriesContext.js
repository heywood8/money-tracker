...
export const CategoriesProvider = ({ children }) => {
  ...
  const addCategory = useCallback(async (category) => {
    try {
      const categoryData = {
        ...category,
        // ID will be auto-generated by database (starting from 1000 for user categories)
      };

      const createdCategory = await CategoriesDB.createCategory(categoryData);
      setCategories(cats => [...cats, createdCategory]);
      setSaveError(null);
