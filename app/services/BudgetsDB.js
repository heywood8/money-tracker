...
export const createBudget = async (budget) => {
  try {
    ...
    const result = await executeQuery(
      'INSERT INTO budgets (category_id, amount, currency, period_type, start_date, end_date, is_recurring, rollover_enabled, created_at, updated_at) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
      [
    ...
    // Return budget data with generated ID
    return mapBudgetFields({ ...budgetData, id: result.lastInsertRowId });
  } catch (error) {
