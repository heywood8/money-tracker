...
- Schema defined in `app/db/schema.js` - tables: accounts, categories, operations, budgets, budgetPlans, budgetPlanLines, budgetPlanLineCategories, budgetPlanLineAccounts, budgetPlanLineLabels, budgetPlanLineGroups, plannedOperations, balanceHistory, appMetadata
